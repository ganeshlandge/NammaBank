...
//	}
	...
	public ResponseEntity<?> register(@RequestBody Account account) {
		...
		if (currentAccount.isPresent()) {
			...
			forgotUsernameRepository
					.save(new ForgotUsername(currentAccount.get().getAccountNum(), code, currentTimestamp));
			return ResponseEntity.ok(new SuccessResponse<>("OTP generated successfully for netbanking registration",
					String.valueOf(code)));
		}
	...
	public ResponseEntity<?> fogotUsername(@RequestBody Account account) {
		...
		if (currentAccount.isPresent()) {
			...
			Timestamp currentTimestamp = new Timestamp(System.currentTimeMillis());
			forgotUsernameRepository.save(new ForgotUsername(currentAccount.get().getAccountNum(),
					currentAccount.get().getUsername(), code, currentTimestamp));
	...
	public ResponseEntity<?> fogotPassword(@RequestBody Account account) {
		...
		if (currentAccount.isPresent()) {
			...
			forgotPasswordRepository
					.save(new ForgotPassword(currentAccount.get().getUsername(), code, currentTimestamp));
			return ResponseEntity.ok(new SuccessResponse<>("OTP generated successfully", String.valueOf(code)));
